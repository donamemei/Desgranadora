...
<div class="row g-4">
    ...
    @foreach([
        ['I1','Integrante 1','Hardware y sensores',  '#cfe2ff','#052c65','bi-cpu',         'Problemas con la máquina, sensores o Arduino'],
        ['I2','Integrante 2','Sistema web',          '#d1e7dd','#0a3622','bi-code-slash',  'Problemas con el software, dashboard o reportes'],
        ['I3','Integrante 3','Documentación',        '#fff3cd','#664d03','bi-file-text',   'Consultas sobre el proyecto, informe o datos'],
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 pt-3 pb-0">
                <h6 class="fw-semibold mb-0">
                    <i class="bi bi-building me-2 text-primary"></i>Instituto técnico
                </h6>
            </div>
            <div class="card-body">
                @foreach([
                    ['bi-geo-alt',    'Ubicación',  'La Paz, Bolivia'],
                    ['bi-calendar3',  'Gestión',    '2024'],
                    ['bi-mortarboard','Carrera',    'Técnico Superior en Informática'],
                    ['bi-clock',      'Horario',    'Lunes a Viernes — 8:00 a 18:00'],
                ] as [$icon,$label,$valor])
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                @foreach([
                    ['bi-bug',              'danger',  'Error en el sistema web',   'Contactar al Integrante 2 — Software'],
                    ['bi-exclamation-triangle','warning','Alerta de la máquina',    'Detener operación. Contactar al Integrante 1'],
                    ['bi-file-earmark-x',   'secondary','Problema con reportes',   'Verificar que hay sesiones en la BD. Contactar I2'],
                    ['bi-wifi-off',         'dark',    'Sin datos en el dashboard', 'Verificar WiFi del Arduino. Contactar Integrante 1'],
